...
// The first event uses static data. Future events will fetch from DB.

// MRT entrance on the 2560x1932 image — left wall aisle, entering at middle horizontal corridor
...
export default function EventMapPage() {
  ...
  useEffect(() => {
    ...
    load();
  }, [isLoggedIn, eventLoading, eventId]);
  ...
  if (eventError) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="font-[family-name:var(--font-sarabun)] text-[#9c7a5b]">{eventError}</p>
      </div>
    );
  }
      ...
      <div ref={mapContainerRef} className="relative flex-1 overflow-hidden bg-[#e0dbd4]">
        ...
        >
          ...
          >
            ...
            <img src={event?.map_image_url ?? "/booth-map-2569.jpg"} alt="ผังบูธ" width={IMAGE_W} height={IMAGE_H} />
