  ...
  return (
    <div className="flex items-center justify-between gap-[8px] w-full mb-[4px]">
      ...
      {eventName ? (
        <Link
          href="/events"
          className="flex items-center gap-[4px] px-[12px] py-[4px] rounded-[20px] bg-[#973C00] font-[family-name:var(--font-sarabun)] font-light text-[14px] text-[#fafaf8] hover:bg-[#7d3200] transition-all min-w-0"
        >
