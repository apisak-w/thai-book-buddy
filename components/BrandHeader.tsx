  ...
  return (
    <div className="flex items-center justify-between gap-[8px] w-full mb-[4px]">
      ...
      {eventName ? (
        <Link
          href="/events"
          className="flex items-center gap-[4px] px-[12px] py-[4px] rounded-[20px] bg-[#fff8ee] border border-[#f0e4d4] font-[family-name:var(--font-sarabun)] font-light text-[14px] text-[#9c7a5b] hover:bg-[#f0e4d4] transition-all min-w-0"
        >
